...
user in an INI file next to Ps1ToExePortable.exe called Ps1ToExePortable.ini.
...
copy AppNamePortable.ini from this directory to Ps1ToExePortable.ini next to
Ps1ToExePortable.exe. The options in the INI file are as follows:
